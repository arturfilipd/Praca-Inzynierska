...
void MapL2::Init(Game* game){
	...
	game->AddEntity(new EnemyBeastman(9.f, 9.f));
...
void MapTest::Init(Game* game){
	...
	game->GetPlayer()->SetMaxHealth(1000000);
	game->GetPlayer()->SetMaxArmor(1000000);
	
	game->GetPlayer()->AddBehaviour(new BehaviourPatrol({ {0,0}, {0,19}, {9, 9}, {19,0}, {19,19}, {9, 9} }));
	game->AddEntity(new EnemyAlienKing(5.f, 3.f));
	game->AddEntity(new EnemyBeastman(2.f, 2.f));
	game->AddEntity(new WeaponPickup(9, 9, new WeaponPistol(game)));
	game->AddEntity(new WeaponPickup(0, 0, new WeaponShotgun(game)));
	game->AddEntity(new WeaponPickup(0, 19, new WeaponMachineGun(game)));
	game->AddEntity(new WeaponPickup(19, 0, new WeaponRocketLauncher(game)));
	game->AddEntity(new WeaponPickup(19, 19, new WeaponCombatRifle(game)));

	game->AddEntity(new HealthCrate(9, 9, 4));
	game->AddEntity(new HealthCrate(0, 0, 4));
	game->AddEntity(new HealthCrate(0, 19, 4));

	game->AddEntity(new ArmorCrate(5, 0, 1));
	game->AddEntity(new ArmorCrate(6, 0, 1));
	game->AddEntity(new ArmorCrate(7, 0, 1));
	...
	game->AddEntity(new EnemyAlien(10.f, 2.f));
	game->AddEntity(new EnemyAlien(2.f, 14.f));
	game->AddEntity(new EnemyAlien(2.f, 12.f));
	game->AddEntity(new EnemyAlien(5.f, 12.f));
	game->AddEntity(new EnemyAlien(5.f, 15.f));
	game->AddEntity(new EnemyAlien(1.f, 15.f));
